...
var hangMan = {
    ...
    //setupGame: function() {
      //  this.selectedPokemon = this.pokemon[Math.floor(Math.random() * pokemon.length)]
    //},
...
makePlatforms: function() {
    ...
    selectedPokemon = this.pokemon[Math.floor(Math.random() * this.pokemon.length)];
